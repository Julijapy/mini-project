...
@pytest.mark.parametrize("user_card, expected", [("Visa Platinum 111122223333444", "Данные введены некорректно"),
...
@pytest.mark.parametrize("date_info, expected", [("2025.02.21", "21.02.2025"),
...
@pytest.mark.parametrize("date_info, expected", [("", "Некорректная дата"),
                                                 (" ", "Некорректная дата"),
