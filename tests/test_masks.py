...
def test_get_mask_card_number_normal_format(card_number, expected):
    """Тестирование функции при стандартных данных при входе и выходе"""
...
@pytest.mark.parametrize(
    ...
    [("11112222333344445555", "**5555"), ("12345678901234567890", "**7890"), ("12121212121212121212", "**1212")],
)
...
@pytest.mark.parametrize(
    "account_number, expected",
    [
        ("111122223333444skypro", "Данные введены некорректно"),
...
def test_get_mask_account_incorrect(account_number, expected):
    """Тестирование функции при некорректных данных при входе"""
    with pytest.raises(ValueError) as exc_info:
